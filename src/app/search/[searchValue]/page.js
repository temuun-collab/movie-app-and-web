...
export default function Page() {
  ...
  const genreName = allGenre.filter((item) => item.searchValue == searchValue);
  const handleAddpage = () => {
    setPage(page + 1);
    setIsNextClick(true);
      ...
      <div className="w-[1440px] flex justify-center items-center ">
        <div className="w-[1280px] flex flex-row">
          <div className="flex flex-col">
            ...
            {searchList && (
              <div className=" w-[806px]  max-sm:w-[400px] text-black text-[20px] font-bold">
                title in "{genreName[0]?.name}"
              </div>
            )}
            <div className=" w-[806px] gap-10 grid grid-cols-4 max-sm:w-[350px] max-sm:grid max-sm:grid-cols-2">
              {page === 1 &&
            ...
            <div className="mt-5 mb-5 ">
              <div className="w-[804px] h-[40px] flex justify-end">
