  ...
  return (
    <div className="w-[100vw] justify-center flex max-sm:w-32">
      <div className="flex justify-center h-[59px] items-center w-[1440px] max-sm:w-32">
        <div className="flex justify-between h-[36px] w-[1280px] items-center max-sm:w-[430px] max-sm:flex max-sm:justify-between ">
          <div
            className="flex gap-[8px] w-[90px] h-[20px]  max-sm:w-[300px] max-sm:h-[20px] cursor-pointer"
