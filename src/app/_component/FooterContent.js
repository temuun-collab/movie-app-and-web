...
export const FooterContent = () => {
  ...
  return (
    <div className="w-[100vw] flex justify-center max-sm:w-[430px]">
      ...
      >
        <div className="flex w-[1280px] h-[200px] justify-between max-sm:w-[335px] max-sm:flex max-sm:flex-col max-sm:gap-[20px]">
          <div className="flex flex-col items-start gap-[5px] max-sm:flex max-sm:flex-row">
            <div
              className="flex gap-[8px] w-[90px] h-[20px]"
          ...
          <div className=" flex gap-[50px] max-sm:flex max-sm:flex-row max-sm:gap-[50px]">
            ...
            <div className="flex flex-col gap-[5px]">
              ...
              <div className="flex max-sm:flex max-sm:flex-col gap-2">
                {/* <a href="Facebook"></a>
              <a href="Instagram"></a>
              <a href="Twitter"></a>
              <a href="Youtube"></a> */}
